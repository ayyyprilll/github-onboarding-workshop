...
- I practiced the PIM configuration steps in Microsoft Entra ID. I also attempted to activate the Microsoft 365 Agents Toolkit extension and connect a secured API plugin for a declarative agent.
...
*Submitted by: April Apakama · ayyyprilll
